        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <i>
                <b className="purple"> Html5, Css3, Bootstrap, Python, JavaScript, Python, Sqlite, MongoDb, Node.js, React.js. </b>
              </i>
              <br />
              <br />
        ...
        <Row>
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              ...
              <li className="social-icons">
                <a
                  href="https://www.instagram.com/chandra_mouli_tarigopula?igsh=OHlicnRucXo5OWY4"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour home-social-icons"
                >
